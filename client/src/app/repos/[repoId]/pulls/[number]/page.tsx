...
export default function PRDetailPage() {
  ...
  const severityFilter = (search.get("severity") as Severity | null) ?? null;
  ...
  if (isLoading) {
    return (
      <AppShell crumb={crumb}>
        <div style={{ padding: "28px 90px", display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ padding: "24px 90px 44px", display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        {tab === "findings" && (
          <FindingsTab
            ...
            onSeverityChange={(s) => setParam("severity", s)}
